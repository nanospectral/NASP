...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nasp features */
        {"nasp", "masternode", &masternode, true, true, false},
        {"nasp", "listmasternodes", &listmasternodes, true, true, false},
        {"nasp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nasp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nasp", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nasp", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nasp", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nasp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nasp", "masternodedebug", &masternodedebug, true, true, false},
        {"nasp", "startmasternode", &startmasternode, true, true, false},
        {"nasp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nasp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nasp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nasp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nasp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nasp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nasp", "mnbudget", &mnbudget, true, true, false},
        {"nasp", "preparebudget", &preparebudget, true, true, false},
        {"nasp", "submitbudget", &submitbudget, true, true, false},
        {"nasp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nasp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nasp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nasp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nasp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nasp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nasp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nasp", "checkbudgets", &checkbudgets, true, true, false},
        {"nasp", "mnsync", &mnsync, true, true, false},
        {"nasp", "spork", &spork, true, true, false},
        {"nasp", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // nasp {"zerocoin", "getzerocoinbalance", &getzerocoinbalance, false, false, true},
        ...
        {"zerocoin", "getznaspseed", &getznaspseed, false, false, true},
        {"zerocoin", "setznaspseed", &setznaspseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdznasp", &searchdznasp, false, false, true},
        {"zerocoin", "dznaspstate", &dznaspstate, false, false, true}
...
{
    return "> nasp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26519/\n";
}
