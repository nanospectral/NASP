...
In order to support loading of multiple wallets in nasp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nasp.cpp.
...
Changes to nasp.cpp
----------------------
nasp.cpp is the entry point into nasp-qt, and as such, will require some minor modifications to provide hooks for
