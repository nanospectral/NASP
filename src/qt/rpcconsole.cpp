                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNASPPathCustom = GetArg("-znaspbackuppath", "");
    ...
    if(!strzNASPPathCustom.empty()) {
        ui->wallet_customznaspbackuppath->setText(QString::fromStdString(strzNASPPathCustom));
        ui->wallet_customznaspbackuppath_label->setVisible(true);
        ui->wallet_customznaspbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNASPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Nasp RPC console.") + "<br>" +
