...
#   c) node1 mines 32 blocks, so now node 0 has 60001nasp, node 1 has 4250nasp, node2 has none.
#   d) node0 sends 601 nasp to node2, in two transactions (301 nasp, then 300 nasp).
