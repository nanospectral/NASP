...
// nasp extern UniValue getzerocoinbalance(const UniValue& params, bool fHelp);
...
extern UniValue setznaspseed(const UniValue& params, bool fHelp);
extern UniValue getznaspseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdznasp(const UniValue& params, bool fHelp);
extern UniValue dznaspstate(const UniValue& params, bool fHelp);
