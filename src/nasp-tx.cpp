...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Nasp Core nasp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nasp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nasp transaction") + "\n" +
                               "  nasp-tx [options] -create [commands]   " + _("Create hex-encoded nasp transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nasp transaction
