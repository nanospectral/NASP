Contributing to Nasp Core
============================

The Nasp Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nasp Core project, and is not to be
confused with overall Nasp Network Protocol consensus changes.

Whether a pull request is merged into Nasp Core rests with the project merge
...
Patches that change Nasp consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nasp consensus, it must have been
...
The project leader is the release manager for each Nasp Core release.
