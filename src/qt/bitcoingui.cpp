                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nasp Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nasp address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nasp: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNASP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nasp Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nasp Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nasp"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nasp addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nasp addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nasp: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nasp Core help message to get a list with possible Nasp command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nasp Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nasp network", "", count));
}
...
{
    QString strTitle = tr("Nasp Core"); // default title
