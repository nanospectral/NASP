 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZNASP));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    // nasp typeWidget->addItem(tr("Received NASP from zNASP"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    // nasp typeWidget->addItem(tr("Zerocoin Mint"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinMint));
    // nasp typeWidget->addItem(tr("Zerocoin Spend"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend));
    // nasp typeWidget->addItem(tr("Zerocoin Spend, Change in zNASP"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNasp));
    // nasp typeWidget->addItem(tr("Zerocoin Spend to Self"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_FromMe));
