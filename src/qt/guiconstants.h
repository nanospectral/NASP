...
/* Nasp GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Nasp"
#define QAPP_ORG_DOMAIN "nasp.org"
#define QAPP_APP_NAME_DEFAULT "Nasp-Qt"
#define QAPP_APP_NAME_TESTNET "Nasp-Qt-testnet"
